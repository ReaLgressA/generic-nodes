...
namespace GenericNodes.Mech.Fields {
    public class GenericArrayDataField : AbstractArrayDataField {
        ...
        public GenericArrayDataField(GraphScheme scheme) : base(scheme) { }

        public GenericArrayDataField(GraphScheme scheme, string name, string arrayType,
