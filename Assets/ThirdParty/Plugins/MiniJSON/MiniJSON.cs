 ...
 */
    ...
    public class MiniJSON {
        ...
        public static string JsonEncode(object json, bool prettyPrint = false) {
            ...
            bool success = prettyPrint
                ? MiniJSON.SerializeValuePretty(json, builder, 0)
                : MiniJSON.SerializeValue(json, builder);
                ...
                if (c == '"') {
                    ...
                    if (c == '"') {
                        ...
                        if (remainingLength >= 4) {
                            ...
                            uint codePoint = uint.Parse(new string(unicodeCharArray),
...
#region Serialization
        ...
        protected static bool SerializeObjectOrArray(object objectOrArray, StringBuilder builder) {
            return objectOrArray is Hashtable
                ...
                : objectOrArray is ArrayList
                    ? SerializeArray((ArrayList)objectOrArray, builder)
                    : false;
        }
        ...
        protected static bool SerializeDictionaryPretty(Dictionary<string, string> dict, StringBuilder builder,
                                                        int depth) {
            AppendTabs(builder, depth);
            builder.Append("{");
        ...
        protected static bool SerializeDictionaryPretty(Dictionary<string, float> dict, StringBuilder builder,
                                                        int depth) {
            AppendTabs(builder, depth);
            builder.Append("{");
        ...
        protected static bool SerializeDictionaryPretty(Dictionary<string, object> dict, StringBuilder builder,
                                                        int depth) {
            builder.AppendLine();
            AppendTabs(builder, depth);
            builder.Append("{");
...
#region Extension methods
    ...
    public static class MiniJsonExtensions {
        ...
        public static T[] GetArray<T>(this Hashtable ht, string key, T[] defaultValue = null)
            where T : IJsonInterface, new() {
            if (ht.Contains(key) && ht[key] != null) {
                ArrayList array = ht[key] as ArrayList;
        ...
        public static List<T> GetList<T>(this Hashtable ht, string key, List<T> defaultValue)
            where T : IJsonInterface, new() {
            if (ht.Contains(key) && ht[key] != null) {
